    ...
    <div className="min-h-dvh bg-(--color-surface) flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-(--color-text-muted) mt-1">Sign in to your Larder account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-[11px] text-(--color-brand) font-medium hover:underline">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
